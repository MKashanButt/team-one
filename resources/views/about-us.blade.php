<x-template>
    <div class="banner about-us display-flex" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="img display-flex">
            <img src="{{ asset('images/about-img-01.webp') }}" alt="">
            <img src="{{ asset('images/home-img-05.webp') }}" alt="">
            <img src="{{ asset('images/sports-img-01.webp') }}" alt="">
        </div>
    </div>
    <div class="whoWeAre" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="employee display-flex banner">
            <div class="content">
                <p>At Team One Management, our mission is to empower artists and athletes by providing personalized
                    guidance
                ...
                <p>
                    ...
                    solutions designed to unlock the full potential of our clients. We understand the unique challenges
                    and
                    demands of the industry, and we leverage our experience and expertise to provide customized
                    strategies
                    that drive growth and elevate careers.
                </p><br>
                <p>
                    As a trusted partner, we prioritize integrity, professionalism, and a client-centric approach. We
                    foster
                    long-term relationships based on trust, clear communication, and a shared commitment to achieving
                    greatness.
                    Our dedicated team is passionate about guiding our clients towards their goals, ensuring their
                    success
                    is
                    our top priority.
                </p><br>
                <p>In addition to our management services, Team One Management is your source for the latest industry
                    news,
                    trends, and insights. Our platform keeps you informed and inspired, offering a curated selection of
                    breaking news, inspiring success stories, and valuable resources to fuel your passion and stay ahead
                    of
                    the game.
    ...
    <div class="whoWeAre" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p>Welcome to Team One Management, your premier destination for comprehensive artist and athlete management
            services. We are dedicated to championing talent and fostering success in the dynamic worlds of
            entertainment
            and sports.</p>
    </div>
</x-template>
