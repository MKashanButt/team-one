<x-template :title="''">
    <div class="banner home-banner display-flex mtop-30" data-aos="fade-up" data-aos-duration="1000">
        <div class="content pleft-50">
            ...
            <p>At Team One Management, our mission is to empower artists and athletes by providing personalized guidance
                and
                strategic support at every step of their journey. From emerging talents to established professionals, we
                are
                committed to nurturing careers, maximizing opportunities, and delivering exceptional results.</p>
        </div>
        <div class="image">
            <img src="{{ asset('images/home-banner-one.webp') }}" alt="">
        </div>
    </div>
    <hr class="hr">
    ...
    <div class="announcements display-flex" data-aos="fade-up" data-aos-duration="1000">
        <div class="content">
            ...
            <p class="mtop-10">Demarco Bennett :Carifta Games 2023 - Gold & Silver Medallist
                ...
                Niesha Burgher: Jul 21-23, 2023 NACAC U18-U23 Championships San Jose, Costa Rica There are two other
                major
                ...
                World Athletics Championships Budapest, Hungary Aug 19-27, 2023 Five Additional XLCR Eagles and Lady
                Eagles
                are expected to be named to these teams, including Ackera Nugent and Nayoka Clunis to the World
                Athletics
                Championships Budapest, Hungary.</p>
        </div>
        <div class="image">
            <img src="{{ asset('images/home-img-04.webp') }}" alt="">
        </div>
    </div>
    ...
    <div class="latest display-flex" data-aos="fade-up" data-aos-duration="1000">
        <div class="content">
            <img src="{{ asset('images/home-latest-img.webp') }}" alt="">
        </div>
    </div>
    ...
    <div class="music display-flex" data-aos="fade-up" data-aos-duration="1000">
        <div class="image display-flex">
            <img src="{{ asset('images/home-music-one.webp') }}" alt="">
            <img src="{{ asset('images/home-music-three.webp') }}" alt="">
            <img src="{{ asset('images/home-music-two.webp') }}" alt="">
        </div>
    </div>
    ...
    <div class="sports display-flex" data-aos="fade-up" data-aos-duration="1000">
        <div class="image">
            <img src="{{ asset('images/home-sports-img.webp') }}" alt="">
        </div>
    </div>
</x-template>
