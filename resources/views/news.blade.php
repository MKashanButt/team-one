<x-template>
    ...
    <div class="news-layouts display-flex">
        <div class="news">
            <h3>LATEST POST</h3>
            <hr class="hr">
            <img src="{{ asset('images/news-img-02.webp') }}" alt="">
            <div class="heading">
            ...
            <div class="news-slides">
                <div class="slides display-flex" data-aos="fade-up" data-aos-duration="1000">
                    <div class="img img-overlay">
                        <img src="{{ asset('images/news-img-03.webp') }}" alt="">
                    </div>
                    <div class="content">
                        <h4>Sean Elliot: What life is likefor 'Memorial Day Miracle' NBA Star after kidnay transplant
                        </h4>
            ...
            <div class="discussedNews">
                <div class="news display-flex" data-aos="fade-up" data-aos-duration="1000">
                    <div class="image img-overlay">
                        <img src="{{ asset('images/news-img-04.webp') }}" alt="">
                    </div>
                    <div class="content">
                        <h4>SPORTS</h4>
                ...
                <div class="news display-flex" data-aos="fade-up" data-aos-duration="1000">
                    <div class="image img-overlay">
                        <img src="{{ asset('images/news-img-05.webp') }}" alt="">
                    </div>
                    <div class="content">
                        <h4>SPORTS</h4>
                        <h4>4x European Champion Zharnel Hughes 🇬🇧 wins his first individual global medal with 100m
                            bronze
                            in 9.88!
                        </h4>
                    </div>
                ...
                <div class="news display-flex" data-aos="fade-up" data-aos-duration="1000">
                    <div class="image img-overlay" onclick="changeDisplay()">
                        <img src="{{ asset('images/news-img-06.webp') }}" alt="">
                    </div>
                    <div class="content">
                        <h4>SPORTS</h4>
